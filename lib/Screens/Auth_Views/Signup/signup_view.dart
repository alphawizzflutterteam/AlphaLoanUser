...
class _SignupScreenState extends State<SignupScreen> {
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: DropdownButton(
                                        isExpanded: true,
                                        value: cityValue,
                                        hint: const Text('City', style: TextStyle(color: Colors.black)),
                                        // Down Arrow Icon
                                        icon: const Icon(Icons.keyboard_arrow_down, color: Colors.black,),
                                        // Array list of items
  ...
  getstate() async {
    ...
    var request = http.MultipartRequest('POST', Uri.parse('https://alphaloan.productsalphawizz.com/Apicontroller/get_state'));
  ...
  getCity(String? sId) async {
    ...
    var request = http.MultipartRequest('POST', Uri.parse("https://alphaloan.productsalphawizz.com/Apicontroller/get_city"));
